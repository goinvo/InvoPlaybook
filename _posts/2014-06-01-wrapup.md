 ...
 * Take into account weeks that Invo did not work on the project due to holidays or vacation.
...
* Prepare a list of final deliverables this should include:
...
* After discussing in person, send out an e-mail with that information. Below is an example.
...
* Final PSD files
 * Layers should be cleanly groups and labeled
* Final PNG files
